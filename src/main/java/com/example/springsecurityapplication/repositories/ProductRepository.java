...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    List<Product> findByTitleContainingIgnoreCase(String name); // поиск по части наименования
    ...
    //Поиск по наименованию и фильтрация по диапазону цены, а также сортировка по ВОЗРАСТАНИЮ цены с учетом категории
    ...
    //Поиск по наименованию и фильтрация по диапазону цены, а также сортировка по УБЫВАНИЮ цены с учетом категории
